...
from src.vtt2minutes.bedrock import BedrockMeetingMinutesGenerator, BedrockError
...
class TestPromptTemplateFeature:
    ...
    def test_default_prompt_japanese(self) -> None:
        ...
        result = generator._get_default_prompt(
            "Test content", "Test Title", "japanese"
        )
    ...
    def test_default_prompt_english(self) -> None:
        ...
        result = generator._get_default_prompt(
            "Test content", "Test Title", "english"
        )
    ...
    def test_template_file_read_error(self) -> None:
        ...
        generator = BedrockMeetingMinutesGenerator(
            prompt_template_file=directory_path
        )
    ...
    def test_integration_with_generate_minutes(self, mock_boto_client: Mock) -> None:
        ...
        mock_response['body'].read.return_value = '{"content": [{"text": "Generated minutes"}]}'
